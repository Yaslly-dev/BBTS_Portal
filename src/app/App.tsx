...
import { Home, Tag, Layers, Award, Building2, FileText, Search, User, Shield, Package } from 'lucide-react';
...
import CadastroItens from './components/CadastroItens';
...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { path: '/cadastro-itens', icon: Package, label: 'Itens' },
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/cadastro-itens" element={<Layout><CadastroItens /></Layout>} />
