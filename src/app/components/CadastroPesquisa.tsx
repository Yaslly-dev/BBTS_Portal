...
export default function CadastroPesquisa() {
  ...
  const ItemRow = ({
    ...
    const updateFn = pesquisaId !== undefined
      ? (field: keyof ItemPesquisa, val: string | number) => updateItemExistente(pesquisaId, item.id, field, val)
      : (field: keyof ItemPesquisa, val: string | number) => updateItem(item.id, field, val);
    const removeFn = pesquisaId !== undefined
    ...
    return (
      <div className="border rounded-lg p-3 bg-gray-50 mb-2">
        <div className="flex items-start justify-between mb-2">
          ...
          <button onClick={removeFn} className="p-1 text-red-500 hover:bg-red-50 rounded">
            <Trash2 size={14} />
          </button>
        </div>
        <div className="grid grid-cols-4 gap-2">
          <div className="col-span-2">
            <input
              type="text"
              value={item.nome}
              onChange={e => updateFn('nome', e.target.value)}
          ...
          <select
            ...
            onChange={e => updateFn('categoria', e.target.value)}
            className="w-full px-2 py-1.5 border rounded text-xs focus:ring-1 focus:ring-[#003E7E]"
          >
          ...
          <input
            ...
            onChange={e => updateFn('quantidade', parseInt(e.target.value) || 1)}
            min="1"
            className="w-full px-2 py-1.5 border rounded text-xs focus:ring-1 focus:ring-[#003E7E]"
          />
          <div className="col-span-4">
            <select
              ...
              onChange={e => updateFn('classificacao', e.target.value)}
              className="w-full px-2 py-1.5 border rounded text-xs focus:ring-1 focus:ring-[#003E7E]"
            >
